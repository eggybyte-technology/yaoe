...
use yaoe_home::{
    ...
    MIHOMO_VALIDATION_VERSION, SING_BOX_VERSION, YaoeError, YaoeResult, sing_box_version_line,
};
...
const LOCAL_PROBE_STDERR_TAIL_LINES: usize = 80;
